...
// добавить описание и возможности бота справа от чата
//добавить !команда вывода всех слов на которые будет отвечать бот и список всех команд.
//добавить сценарий в виде ветвления.
//добавить !функцию анекдот и викторину
