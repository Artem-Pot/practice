...
// добавить изменение темы на тумную + изображение фона
// добавить чтобы изменялось с помощью чек бокса
// добавить звуки
...
// поправить бордер border-right 1 px, у правой колонки, а то пришлось делать бордер для поля с собщением
